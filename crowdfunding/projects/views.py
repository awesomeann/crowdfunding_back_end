...
from .serializers import ProjectSerializer, PledgeSerializer, ProjectDetailSerializer, PledgeDetailSerializer, ProjectStatusSerializer
...
class PledgeList(APIView):
    ...
    def get(self, request,project_id=None):
            if project_id:
                pledges = Pledge.objects.all().filter(project=project_id)
            else:
